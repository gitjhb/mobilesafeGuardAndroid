package com.yheproject.mobilesafe.provider;
...
public class AppLockProvider extends ContentProvider {
	...
	private static Uri changeuri = Uri
			.parse("content://com.yheproject.applockprovider");
	private AppLockDao dao;
	static {
		matcher.addURI("com.yheproject.applockprovider", "insert", INSERT);
		matcher.addURI("com.yheproject.applockprovider", "delete", DELETE);
	}
