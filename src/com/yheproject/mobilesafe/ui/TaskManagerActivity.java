...
import com.yheproject.mobilesafe.MyApplication;
import com.yheproject.mobilesafe.R;
import com.yheproject.mobilesafe.domain.TaskInfo;
import com.yheproject.mobilesafe.engine.TaskInfoProvider;
import com.yheproject.mobilesafe.ui.stub.MyToast;
...
public class TaskManagerActivity extends Activity {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			String text = tv_avail_memory.getText().toString() + "  Total Spaces:"
					+ strtotalmemory;
		...
		lv_task_manager.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (obj instanceof TaskInfo) {
					...
					if ("com.yheproject.mobilesafe".equals(packname)
	...
	private void setTitleData() {
		tv_task_count.setText("Processes Number: " + getProcessCount());
		tv_avail_memory.setText("Available Spaces: "
	...
	public void killTask(View view) {
		...
		MyToast.showToast(this, R.drawable.notification, "Killed " + total
				+ " processes,Released " + size + " spaces");
		// 通知ui更新
		// adapter = new TaskInfoAdapter();
		// lv_task_manager.setAdapter(adapter);
		fillData();
	...
	private class TaskInfoAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (position == 0) {
				...
				tv_userapp.setText("User's Processes " + usertaskinfos.size());
				return tv_userapp;
			} else if (position <= usertaskinfos.size()) {
				...
				holder.tv_memory_size.setText("Spaces Used: "
				...
				tv_systemapp.setText("System Processes: " + systemtaskinfos.size());
