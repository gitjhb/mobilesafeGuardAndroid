...
import com.yheproject.mobilesafe.db.dao.AppLockDao;
...
public class AppLockActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ll_app_manager_loading = (LinearLayout) this
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (dao.find(packname)) {
					...
					getContentResolver()
							.delete(Uri
									.parse("content://com.yheproject.applockprovider/delete"),
					...
					getContentResolver()
							.insert(Uri
									.parse("content://com.yheproject.applockprovider/insert"),
									values);
	...
	private class AppLockAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ImageView iv_lock_status = (ImageView) view
					.findViewById(R.id.iv_app_lock_status);
			TextView tv_pack_name = (TextView) view
					.findViewById(R.id.tv_app_packname);
